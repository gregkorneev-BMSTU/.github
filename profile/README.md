# IU5-14B — Archive (Демо A)

**Навигация:** [Semester 2](#semester-2) · [Semester 1](#semester-1) · [homework](#homework) · [reports](#reports) · [lecture-theory](#lecture-theory) · [tests](#tests)

---

## Semester 2

Эта секция предназначена для новых работ второго семестра (префиксы `s2*`).
В примере ниже таблицы разделены на две колонки, как и в оригинальном варианте, чтобы сохранить привычный формат. При необходимости строки можно дополнять новыми лабораторными и семинарами.
...
<tr>
  ...
  <!-- пример строк для второго семестра -->
  ...
  <!-- добавляйте здесь другие s2_lab* -->
  </table>
  ...
  <!-- добавляйте здесь другие s2_sem* -->
  </table>
...
<details>
<summary><b>Показать/скрыть архив первого семестра</b></summary>
